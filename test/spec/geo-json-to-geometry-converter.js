...
describe("GeoJsonToGeometryConverter", function () {
    ...
    it ("can convert a GeoJson Polygon to a Polygon", function () {
        ...
        expect(polygon.coordinates[0][1].longitude).toBe(101.0);
        expect(polygon.coordinates[0][1].latitude).toBe(0.0);
        expect(polygon.coordinates[0][2].longitude).toBe(101.0);
        expect(polygon.coordinates[0][2].latitude).toBe(1.0);
        expect(polygon.coordinates[0][3].longitude).toBe(100.0);
        expect(polygon.coordinates[0][3].latitude).toBe(1.0);
    ...
    it ("can convert a GeoJson MultiPolygon to a MultiPolygon", function () {
        ...
        expect(polygon.coordinates[0].coordinates[0][1].longitude).toBe(103.0);
        expect(polygon.coordinates[0].coordinates[0][1].latitude).toBe(2.0);
        ...
        expect(polygon.coordinates[0].coordinates[0][3].longitude).toBe(102.0);
        expect(polygon.coordinates[0].coordinates[0][3].latitude).toBe(3.0);
        ...
        expect(polygon.coordinates[1].coordinates[0][1].longitude).toBe(101.0);
        expect(polygon.coordinates[1].coordinates[0][1].latitude).toBe(0.0);
        ...
        expect(polygon.coordinates[1].coordinates[0][3].longitude).toBe(100.0);
        expect(polygon.coordinates[1].coordinates[0][3].latitude).toBe(1.0);
        ...
        expect(polygon.coordinates[1].coordinates[1][1].longitude).toBe(100.2);
        expect(polygon.coordinates[1].coordinates[1][1].latitude).toBe(0.8);
        ...
        expect(polygon.coordinates[1].coordinates[1][3].longitude).toBe(100.8);
        expect(polygon.coordinates[1].coordinates[1][3].latitude).toBe(0.2);
